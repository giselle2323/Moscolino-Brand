export const Gallery = () => {
  return (
    <section className="text-gray-600 body-font bg-custom_gray">
      <div className="container px-5 py-24 mx-auto text-center">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">My Works</h1>
        </div>
        ...
        <button className='bg-transparent border-4 border-dark_blue p-4 text-dark_blue my-4'>View More</button>
      </div>
    </section>
  );
};
